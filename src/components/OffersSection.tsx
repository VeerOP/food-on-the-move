...
import { Sparkles, Tag, Truck, ArrowRight, CheckCircle2, ShieldCheck } from "lucide-react";
      ...
      <div className="section-container relative z-10">
        ...
        >
          <span className="text-primary font-semibold uppercase tracking-wider text-sm inline-flex items-center gap-2">
            <Tag className="w-4 h-4" /> Exclusive Perk
          </span>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl mt-3 mb-4 text-foreground font-bold">
            FREE DELIVERY ON <span className="text-gradient">ORDERS ABOVE ₹1,000</span>
          </h2>
          <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
            Order your favourite roasted millet snacks and enjoy zero delivery fee across Mumbai & Navi Mumbai on all orders of ₹1,000 or more!
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-center relative z-10">
            ...
            <div className="md:col-span-5 flex flex-col items-center justify-center">
              ...
              <span className="text-xs text-muted-foreground mt-3 font-medium text-center">
                100% Roasted Millets, Cookies & Crunchy Sticks
              </span>
            </div>
            ...
            <div className="md:col-span-7 flex flex-col justify-center text-left">
              ...
              <h3 className="font-display text-2xl sm:text-3xl text-foreground font-bold leading-tight mb-3">
                Zero Delivery Charges on ₹1,000+
              </h3>
              ...
              <div className="space-y-2.5 mb-6 text-xs sm:text-sm">
                <div className="flex items-start gap-2.5">
                  ...
                  <span className="text-foreground">
                    <strong className="font-semibold">Auto-Applied in Cart:</strong> Free delivery applies automatically once your cart hits ₹1,000.
                  </span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Truck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                  <span className="text-foreground">
                    <strong className="font-semibold">Mumbai & Navi Mumbai:</strong> Swift doorstep courier dispatch directly from our kitchen.
                  </span>
                </div>
                <div className="flex items-start gap-2.5">
                  <ShieldCheck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                  <span className="text-foreground">
                    <strong className="font-semibold">Guilt-Free Snacking:</strong> 100% non-fried, zero trans fat, wholesome nutrition.
                  </span>
                </div>
              </div>
              ...
              <div className="mb-6 p-4 rounded-2xl bg-background/80 border border-border/80">
                <div className="flex items-center justify-between text-xs mb-1.5 font-medium">
                  <span className="text-muted-foreground">
                    {isUnlocked ? "🎉 Free Delivery Unlocked in Cart!" : `Current Cart: ₹${subtotal.toFixed(0)} / ₹${threshold}`}
                  </span>
                  <span className="text-primary font-bold">
                    {isUnlocked ? "FREE SHIPPING UNLOCKED" : `Add ₹${amountNeeded.toFixed(0)} for Free Delivery`}
                  </span>
                </div>
