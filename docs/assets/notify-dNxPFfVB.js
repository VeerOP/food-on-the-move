import{E as c}from"./index-CAnyJ5G4.js";const d="919152856405";function m(e){const t=e.customerName?e.customerName.trim().split(/\s+/)[0]:"there",n=e.orderId.length>8?e.orderId.slice(0,8):e.orderId,r=e.items.map(o=>{const a=o.variant?` [${c(o.variant)}]`:"",i=o.packItems&&o.packItems.length?`
