import{z as c}from"./index-CjW1bx7-.js";const u="919152856405";function d(e){const t=e.customerName?e.customerName.trim().split(/\s+/)[0]:"there",n=e.orderId.length>8?e.orderId.slice(0,8):e.orderId,r=e.items.map(o=>{const a=o.variant?` [${c(o.variant)}]`:"",i=o.packItems&&o.packItems.length?`
